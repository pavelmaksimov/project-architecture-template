...
NotEmptyStrT = Annotated[str, AfterValidator(not_empty_validator)]
...
class SettingsValidator(BaseSettings):
    ...
    DATABASE_PRE_PING: Annotated[bool, "Checks and creates connection if closed before requesting"] = False
